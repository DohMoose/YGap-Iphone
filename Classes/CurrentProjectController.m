...
@implementation CurrentProjectController


- (IBAction) map {
	TourController *tourController = [[TourController alloc] initWithNibName:@"TourController" bundle:nil];
	tourController.title = @"Tour Map";
